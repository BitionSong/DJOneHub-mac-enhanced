...
final class GPSMapPanel: NSObject {
    ...
    override init() {
        panel = NSPanel(
            contentRect: NSRect(x: 0, y: 0, width: 314, height: 154),
    ...
    private func buildContent() {
        ...
        let overlayLabel = NSTextField(labelWithString: "校准中")
        ...
        signalRow.spacing = 7
        let textStack = NSStackView(views: [stateLabel, detailLabel, signalRow])
        ...
        NSLayoutConstraint.activate([
            ...
            mapView.widthAnchor.constraint(equalToConstant: 122),
            mapView.heightAnchor.constraint(equalToConstant: 122),
            ...
            textStack.leadingAnchor.constraint(equalTo: mapView.trailingAnchor, constant: 15),
